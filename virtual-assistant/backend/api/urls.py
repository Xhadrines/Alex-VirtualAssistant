...
urlpatterns = [
    ...
    path(
        "facultate/update/<int:pk>/",
        FacultateUpdateView.as_view(),
        name="facultate-update",
    ),
    path(
        "facultate/delete/<int:pk>/",
        FacultateUpdateView.as_view(),
        name="facultate-delete",
    ),
    path("facultate/filter/", FacultateFilteredView.as_view(), name="facultate-filter"),
    path(
        "specializare/list/", SpecializareListView.as_view(), name="specializare-list"
    ),
    path(
        "specializare/create/",
        SpecializareCreateView.as_view(),
        name="specializare-create",
    ),
    path(
        "specializare/update/<int:pk>/",
        SpecializareUpdateView.as_view(),
        name="specializare-update",
    ),
    path(
        "specializare/delete/<int:pk>/",
        SpecializareDeleteView.as_view(),
        name="specializare-delete",
    ),
    path(
        "specializare/filter/",
        SpecializareFilteredView.as_view(),
        name="specializare-filter",
    ),
    ...
    path(
        "adevetinta/create/", AdevetintaCreateView.as_view(), name="adevetinta-create"
    ),
    path(
        "adevetinta/update/<int:pk>/",
        AdevetintaUpdateView.as_view(),
        name="adevetinta-update",
    ),
    path(
        "adevetinta/delete/<int:pk>/",
        AdevetintaDeleteView.as_view(),
        name="adevetinta-delete",
    ),
    path("conversation/chat/", ConversationChat.as_view(), name="conversation-chat"),
    path(
        "conversation/history/list/",
        ConversationHistoryListView.as_view(),
        name="conversation-history-list",
    ),
    path(
        "conversation/history/create/",
        ConversationHistoryCreateView.as_view(),
        name="conversation-history-create",
    ),
    path(
        "conversation/history/update/<int:pk>/",
        ConversationHistoryUpdateView.as_view(),
        name="conversation-history-update",
    ),
    path(
        "conversation/history/delete/<int:pk>/",
        ConversationHistoryDeleteView.as_view(),
        name="conversation-history-delete",
    ),
    path(
        "conversation/history/filter/<int:pk>/",
        ConversationHistoryFilteredView.as_view(),
        name="conversation-history-filter",
    ),
